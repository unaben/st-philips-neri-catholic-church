    ...
    >
      ...
      <div className={styles.section}>
        ...
        >
          ...
          {/* Previous parish */}
          <Field id="previousParish" label="Previous Parish / Church" optional>
            <input
              id="previousParish"
              name="previousParish"
              type="text"
          ...
          <Field
            ...
            error={showError("heardAboutUs") ? errors.heardAboutUs : undefined}
          >
            <select
              id="heardAboutUs"
              name="heardAboutUs"
      ...
      <div className={styles.formFooter}>
        ...
        >
          {serverError && (
            <p role="alert" style={{ fontSize: "0.85rem", color: "#e53e3e" }}>
              ⚠ {serverError}
            </p>
          )}
          <button
