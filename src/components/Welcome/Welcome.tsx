      ...
      <div className={styles.inner}>
        ...
        >
          <p className={styles.message}>
            We are happy you are here to view our website, you will find
            information about the Parish and its activities. Faith comes from
            hearing but here on our website, what you see, read and reflect on,
            we hope will get you thinking and actively participating in our
            mission and vision. May your visit to this site translate into
            blessing and hunger for doing the will of God.
          </p>
          <p className={styles.blessing}>Lots of love and blessings !</p>

          <div className={styles.priestRow}>
            <div>
              <h2 className={styles.priestName}>Parish Priest</h2>
